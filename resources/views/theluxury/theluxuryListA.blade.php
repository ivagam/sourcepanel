...
@php
    $title = 'Theluxury List A';
    $subTitle = 'Theluxury List A';
    $script = '';
@endphp
...
<div class="card basic-data-table">
    <div class="card-header">
        ...
        <div class="row align-items-center mt-3">
            <div class="col-md-7">
                <form method="GET" action="{{ route('theluxuryListA') }}">
                    <div class="d-flex gap-2">
                        ...
                        {{-- Text Search --}}
                        <input type="text" name="search" value="{{ request('searchtheluxury') }}" class="form-control" placeholder="Search">

                        <button class="btn btn-primary" type="submit">Search</button>
                        <a href="{{ route('theluxuryListA') }}" class="btn btn-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12 d-flex justify-content-end">
                {{ $theluxury->appends(request()->query())->links() }}
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <div class="d-flex align-items-center gap-10 justify-content-center">
                                    <a href="{{ route('editTheluxury', $product->scrape_product_id) }}">
                                        <button type="button" class="bg-success-focus text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle">
                                            <iconify-icon icon="lucide:edit" class="menu-icon"></iconify-icon>
                                        </button>
                                    </a>

                                    <a href="{{ route('duplicateTheluxuryProduct', $product->scrape_product_id) }}">
